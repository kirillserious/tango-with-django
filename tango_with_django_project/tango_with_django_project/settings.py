...
SECRET_KEY = 'j)v@x%)*m_&rbfr&nm1b4vkvq!r9-77mpxcos@#jn@ptd(nss='
...
SIMPLE_BACKEND_REDIRECT_URL ='/rango/'                                # пытаются получить доступ к страницам, которые требуют аутентификации
